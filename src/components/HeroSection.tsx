    ...
    <section id="home" className="min-h-screen flex items-center pt-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl mb-8 text-gray-300 font-normal animate-fade-in" style={{animationDelay: '0.2s'}}>
          ...
          <p className="text-lg text-gray-400 mb-10 animate-fade-in" style={{animationDelay: '0.4s'}}>
            I build full-stack applications with MongoDB, Express, React, and Node.js.
            Focused on creating responsive, user-friendly experiences with clean code.
          </p>
          
          <div className="flex flex-wrap gap-6 justify-center mb-12 animate-fade-in" style={{animationDelay: '0.6s'}}>
